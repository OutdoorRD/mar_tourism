...
forest <- read_sf(paste0("R2R_Paper/Scenarios/", anum, "_", aname, "/T_AOI_", anum, "_forest.geojson"))
coral <- read_sf(paste0("R2R_Paper/Scenarios/", anum, "_", aname, "/T_AOI_", anum, "_coral.geojson"))
