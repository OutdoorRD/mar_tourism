####
#### Fire Forest scenario non-climate predictor prep
#### Forked form preparing_non_climate_predictors.R on 4/13/21
...
forest <- read_sf("ROOT/11_12_mngt_fire/T_AOI_s12_fire_fors_forest.geojson")
######
...
## Write it out
write_sf(preds_mangrove, paste0("mar_tourism/Data/Scenarios/s12_fire_fors_NonClimatePredictors_", dddd, ".geojson"), delete_dsn = TRUE)
write_csv(preds_mangrove %>% st_set_geometry(NULL), paste0("mar_tourism/Data/Scenarios/s12_fire_fors_NonClimatePredictors_", dddd, ".csv"))
