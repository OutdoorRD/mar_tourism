####
#### Fire Mangrove scenario non-climate predictor prep
#### Forked form Fire Forest preparing_non_climate_predictors.R on 4/13/21
...
mangrove <- read_sf("ROOT/11_fire_mang/Mangrove_eraseFireRiskAMR/Mangrove_Fire_32616.shp")
...
## Write it out
write_sf(preds_mangrove, paste0("mar_tourism/Data/Scenarios/s11_fire_mang_NonClimatePredictors_", dddd, ".geojson"), delete_dsn = TRUE)
write_csv(preds_mangrove %>% st_set_geometry(NULL), paste0("mar_tourism/Data/Scenarios/s11_fire_mang_NonClimatePredictors_", dddd, ".csv"))
