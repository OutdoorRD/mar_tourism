...
### THIS IS THE DIFFERENCE FOR S2
forest <- read_sf("ROOT/02_prot_fors/T_AOI_s2_prot_fors_forest.geojson")
coral <- read_sf("ROOT/02_prot_fors/T_AOI_s2_prot_fors_coral.geojson")
...
## Write it out
write_sf(preds_mangrove, paste0("mar_tourism/Data/Scenarios/s2_prot_fors_NonClimatePredictors_", dddd, ".geojson"), delete_dsn = TRUE)
write_csv(preds_mangrove %>% st_set_geometry(NULL), paste0("mar_tourism/Data/Scenarios/s2_prot_fors_NonClimatePredictors_", dddd, ".csv"))
