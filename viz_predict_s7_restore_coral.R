...
### Forked from viz_predict_s4_restore_mangroves.R on 12/22/20
###
...
# ONly doing restore coral for BZ
anum <- "07" #restore coral
aname <- "rest_corl"
...
newNonClimate <- read_csv("mar_tourism/Data/Scenarios/s7_rest_corl_NonClimatePredictors_20201222.csv")
