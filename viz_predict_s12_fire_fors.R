#####
### Using the Viz Model to predict Viz under s12 Fire Forest scenarios
### Forked from viz_predict_s4_restore_mangroves on 4/13/21
...
newNonClimate <- read_csv("mar_tourism/Data/Scenarios/s12_fire_fors_NonClimatePredictors_20210413.csv")
